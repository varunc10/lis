...
def preprocess(image):
    kernel = np.array(
        [[0.0, 1.0, 0.0], [1.0, 2.0, 1.0], [0.0, 1.0, 0.0]], dtype=np.uint8
    )
...
def printText(frame, text):
    ...
    cv2.putText(
        frame, text, (width // 2, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2
    )
